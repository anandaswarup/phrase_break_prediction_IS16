...
def run_experiment():
    ...
    parser.add_argument("--lstm_layer_dim", type = int, help = "Dimension of the LSTM layer", required = True)
    ...
    lstm_layer_dim = args.lstm_layer_dim
    l_rate = args.l_rate
    mom = args.momentum
    ...
    ########## LSTM MODEL BUILDING AND COMPILING ##########
